...
const sourceText = `function X() {\n${slice}\n}`;
const sourceFile = ts.createSourceFile('slice.tsx', sourceText, ts.ScriptTarget.Latest, true, ts.ScriptKind.TSX);
...
const snippetLine = sourceText.split(/\r?\n/)[lineAndCharacter.line] ?? '';
